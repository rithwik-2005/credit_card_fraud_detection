...
class ModelEvaluation:
    ...
    def eval_metrics(self, actual, pred):
        ...
        report = classification_report(actual, pred, zero_division=0)
    ...
    def log_into_mlflow(self):
        try:
            ...
            y_test = pd.read_csv(self.config.y_test_data_path).squeeze()
            ...
            with mlflow.start_run() as run:
                ...
                accuracy, f1, report, matrix = self.eval_metrics(y_test, predictions)
                ...
                if tracking_url_type_store != "file":
                    self.promote_best_model(run.info.run_id)
